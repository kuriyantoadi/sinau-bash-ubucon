...
function soal1() {
  ...
  echo ""
  echo "To view the contents of files in a directory with the command ?"
  echo -n "   Answer : "
  read jwb1
...
function soal2() {
  ...
  echo ""
  echo "To enter a directory with the command ? "
  echo -n "   Answer : "
  read jwb2
...
function soal3() {
  ...
  echo ""
  echo "To check the position in which directory with the command ? "
  echo -n "   Answer : "
  read jwb3
...
function soal4() {
  ...
  echo ""
  echo "To rename a file with the command ? "
  echo -n "   Answer : "
  read jwb4
...
function soal5() {
  ...
  echo ""
  echo "To rename a folder with the command ? "
  echo -n "   Answer : "
  read jwb5
...
function soal6() {
  ...
  echo ""
  echo "To delete a file with the command ? "
  echo -n "   Answer : "
  read jwb6
...
function soal7() {
  ...
  echo ""
  echo "To create a new folder with the command ? "
  echo -n "   Answer : "
  read jwb7
...
function soal8() {
  ...
  echo ""
  echo "To do remote ssh with the command ? "
  echo -n "   Answer : "
  read jwb8
...
function soal9() {
  ...
  echo ""
  echo "To add a new user with the command ? "
  echo -n "   Answer : "
  read jwb9
...
function soal10() {
  ...
  echo ""
  echo "To check who is logged in with the command ? "
  echo -n "   Answer : "
  read jwb10
...
function soal11() {
  ...
  echo ""
  echo "To copy files with the command ? "
  echo -n "    Answer : "
  read jwb11
...
function soal12() {
  ...
  echo ""
  echo "To archive a file to zip with the command ? "
  echo -n "     Answer : "
  read jwb12
...
function soal13() {
  ...
  echo ""
  echo "To open a zip file with the command ? "
  echo -n "    Answer : "
  read jwb13
...
function soal14() {
  ...
  echo ""
  echo "To change permissions with the command ? "
  echo -n "    Answer : "
  read jwb14
...
function soal15() {
  ...
  echo ""
  echo "To change the ownership of a file or group with the command ? "
  echo -n "    Answer : "
  read jwb15
...
function soal16() {
  ...
  echo ""
  echo "To view the contents of files in a directory with multiple formats with the command ? "
  echo -n "   Answer : "
  read jwb16
...
function soal17() {
  ...
  echo ""
  echo "To copy a directory and its contents with the command ? "
  echo -n "    Answer : "
  read jwb17
...
function soal18() {
  ...
  echo ""
  echo "To delete a directory and its contents with the command ? "
  echo -n "   Answer : "
  read jwb18
...
function soal19() {
  ...
  echo ""
  echo "To view the contents of a text file with the command ? "
  echo -n "   Answer : "
  read jwb19
...
function soal20() {
  ...
  echo ""
  echo "Delete the directory with a single command line. /smk/tkj/ "
  echo -n "   Answer : "
  read jwb20
